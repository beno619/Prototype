 ...
 * on 2013-12-04 at 19:35:58 UTC 
 * Modify at your own risk.
 */

package com.fidelb.benchmark.benchresultendpoint;
...
public class Benchresultendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetBenchResult extends BenchresultendpointRequest<com.fidelb.benchmark.benchresultendpoint.model.BenchResult> {
    ...
    protected GetBenchResult(java.lang.Long id) {
      super(Benchresultendpoint.this, "GET", REST_PATH, null, com.fidelb.benchmark.benchresultendpoint.model.BenchResult.class);
   ...
   * operation.
   *
   * @param content the {@link com.fidelb.benchmark.benchresultendpoint.model.BenchResult}
   * @return the request
   */
  public InsertBenchResult insertBenchResult(com.fidelb.benchmark.benchresultendpoint.model.BenchResult content) throws java.io.IOException {
    InsertBenchResult result = new InsertBenchResult(content);
    initialize(result);
    return result;
  }

  public class InsertBenchResult extends BenchresultendpointRequest<com.fidelb.benchmark.benchresultendpoint.model.BenchResult> {
     ...
     * @since 1.13
     */
    protected InsertBenchResult(com.fidelb.benchmark.benchresultendpoint.model.BenchResult content) {
      super(Benchresultendpoint.this, "POST", REST_PATH, content, com.fidelb.benchmark.benchresultendpoint.model.BenchResult.class);
    }
  ...
  public class ListBenchResult extends BenchresultendpointRequest<com.fidelb.benchmark.benchresultendpoint.model.CollectionResponseBenchResult> {
    ...
    protected ListBenchResult() {
      super(Benchresultendpoint.this, "GET", REST_PATH, null, com.fidelb.benchmark.benchresultendpoint.model.CollectionResponseBenchResult.class);
    }
   ...
   * @return the request
   */
  public UpdateBenchResult updateBenchResult(com.fidelb.benchmark.benchresultendpoint.model.BenchResult content) throws java.io.IOException {
    UpdateBenchResult result = new UpdateBenchResult(content);
    initialize(result);
    return result;
  }

  public class UpdateBenchResult extends BenchresultendpointRequest<com.fidelb.benchmark.benchresultendpoint.model.BenchResult> {
     ...
     * @since 1.13
     */
    protected UpdateBenchResult(com.fidelb.benchmark.benchresultendpoint.model.BenchResult content) {
      super(Benchresultendpoint.this, "PUT", REST_PATH, content, com.fidelb.benchmark.benchresultendpoint.model.BenchResult.class);
    }
