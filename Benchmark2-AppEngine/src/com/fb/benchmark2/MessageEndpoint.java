 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "fb.com", ownerName = "fb.com", packagePath="benchmark2"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyAxiz3ivnB5P1Ol4ZH-ZJCYAuJQEUhQQm0";
